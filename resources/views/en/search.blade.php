...
@slot('meta')
<title>Search Results | Psychology4.me</title>
<meta name="description" content="Here you can find all search results to your query. " />
<meta property="og:title" content="Search Results | Psychology4.me" />
<meta property="og:image" content="{{ asset('media/website/landing/social.jpg') }}" />
<meta property="og:site_name" content="Search Results | Psychology4.me" />
<meta property="og:description" content="Here you can find all search results to your query. " />
<meta name="twitter:title" content="Search Results | Psychology4.me" />
<meta name="twitter:description" content="Here you can find all search results to your query. " />
                    ...
                    <div class="tt-row no-padding-bottom no-margin-bottom">
                      <div class="tt-col-lg-12">
                        <div class="tt-heading tt-heading-xlg">
                          <h2 class="tt-heading-title text-center">Search Results</h2>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="tt-row no-padding-bottom no-margin-bottom">
                        <div class="tt-col-lg-12">
                          <div class="tt-heading tt-heading-lg">
                            <h2 class="tt-heading-title text-center">No posts found</h2>
                          </div>
                        </div>
                      </div>
                      @endif
