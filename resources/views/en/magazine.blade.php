...
@slot('meta')
<title>Psychology4.me: Magazine</title>
<meta name="description" content="Welcome to the Magazine, where we share actionable advice for developing the mental strength you need to regain balance in life." />
<meta property="og:title" content="Psychology4.me: Magazine" />
<meta property="og:image" content="{{ asset('media/website/landing/social.jpg') }}" />
<meta property="og:site_name" content="Psychology4.me: Magazine" />
<meta property="og:description" content="Welcome to the Magazine, where we share actionable advice for developing the mental strength you need to regain balance in life." />
<meta name="twitter:title" content="Psychology4.me: Magazine" />
<meta name="twitter:description" content="Welcome to the Magazine, where we share actionable advice for developing the mental strength you need to regain balance in life." />
...
@slot('content')
            ...
            @endcomponent
            <div id="content-wrap">
              <div id="page-header" class="ph-full ph-cap-xxlg ph-image-cropped ph-image-cover-1 ph-content-parallax">
                <div class="page-header-inner tt-wrap">
    							<div class="ph-image">
    								<div class="ph-image-inner">
    									<img src="{{ asset('media/blog/trending/ph-5.jpg') }}" alt="Magazine Psychology4.me">
    								</div>
    							</div>
    							<div class="ph-caption">
    								<h1 class="ph-caption-title ph-appear">Magazine</h1>
    								<div class="ph-caption-title-ghost ph-appear">Trending</div>
    								<div class="ph-caption-subtitle ph-appear">Selected Trending Articles.</div>
    							</div>
    						</div>
